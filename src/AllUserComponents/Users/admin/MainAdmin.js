...
const MainAdmin = () => {
    ...
    return ( <>
    {visible === "AdminView" && (<AdminView setVisible={setVisible} setEditAdminId={setEditAdminId}/>)}
     {visible === "AddAmin" && (<Add_Admin setVisible={setVisible}/>)}
     {visible === "EditAdmin" && (<EditAdmin EditAdminId={EditAdminId} setVisible={setVisible}/>)}
    </> );
}
