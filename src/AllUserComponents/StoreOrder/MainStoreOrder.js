...
const StoreOrderMain = () => {
  const [OrderStatusData, setOrderStatusData] = useState("Paid");
  const [OrderTypeData, setOrderTypeData] = useState("Online");
  ...
  return (
    <>
      <div className="q-order-main-page">
        <StoreOrderFilter onFilterDataChange={handleFilterDataChange} />
      </div>
      <div className="mt-10">
