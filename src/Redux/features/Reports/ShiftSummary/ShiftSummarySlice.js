...
export const fetchshiftsummaryData = createAsyncThunk('ShiftSummarylist/fetchshiftsummaryData.', async (data) => {
  try {
    const response = await axios.post(BASE_URL + GET_SHIFT_SUMMARY_LIST, data, { headers: { "Content-Type": "multipart/form-data" } })
