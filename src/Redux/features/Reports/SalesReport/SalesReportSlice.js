...
export const fetchSalesReportData = createAsyncThunk('SalesReportList/fetchSalesReportData.', async (data) => {
    try {

        // console.log(BASE_URL + VENDORS_SALES_REPORT)
        const response = await axios.post(BASE_URL + SALES_REPORT_LIST, data, { headers: { "Content-Type": "multipart/form-data" } })
