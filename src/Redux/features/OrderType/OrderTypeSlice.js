...
export const fetchOrderTypeData = createAsyncThunk('orderType/fetchOrderTypeData.', async (data) => {
    try {
        const response = await axios.post(BASE_URL + LIST_ALL_ORDER_TYPE, data, { headers: { "Content-Type": "multipart/form-data" } })
