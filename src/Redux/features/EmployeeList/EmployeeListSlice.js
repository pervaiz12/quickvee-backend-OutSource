...
export const fetchEmployeeListData = createAsyncThunk('isEmployeeList/fetchEmployeeListData.', async (data) => {
    try {
        const response = await axios.post(BASE_URL + LIST_ALL_EMPLOYEE, data, { headers: { "Content-Type": "multipart/form-data" } })
