...
export const fetchMerchantsList = createAsyncThunk('ExportInventory/fetchMerchantsList.',async(data)=> {
    try{
        const response = await axios.post(BASE_URL + LIST_ALL_MERCHANTS, data, { headers: { "Content-Type": "multipart/form-data" } })
