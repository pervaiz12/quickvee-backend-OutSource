...
import { BASE_URL, COUPON_LIST,COUPON_DELETE } from "../../../Constants/Config";
...
export const fetchCouponList = createAsyncThunk('couponList/fetchCouponList.', async (data) => {
    try {
...
export const deleteCoupon = createAsyncThunk('couponList/deleteCoupon', async (data) => {
    try 
    {
        const response = await axios.post(BASE_URL + COUPON_DELETE, data,{ headers: { "Content-Type": "multipart/form-data" }});
        if(response)
        {
