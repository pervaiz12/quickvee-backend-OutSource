...
export default function EditCustomer() {
    const {handleEditData,customerData,handleChange,customerRadio,AdminRadio,merchantRadio,handleChangeRadio,handleSubmitCustomerRecord,successMessage}=EditCustomerFunction()
    const  {id}  = useParams();
    useEffect(()=>{
         handleEditData(id)
    },[id])
