...
// -------------------radio button end---------------------------
    ...
    const handleChange=(e)=>{
      ...
      if (name === 'phone') {
        ...
        //   console.log('Invalid phone number length');
          updatedErrors[name] = 'Invalid phone number length'; // Set an error message in the state
          setStore({
            ...store,
            errors: updatedErrors
          });
    ...
    ,radioErros,stateList,adminList,stateList,adminId,onChangeAdminId,handleSubmitMerchant,errorAdminId,errorPin}
