...
const NetSalesFilter = () => {
  const NetSalesData = useSelector((state) => state.NewItemSalesReportList);
  
  return (
    <>
      {NetSalesData && NetSalesData.NewItemSalesData && (
        <>
                ...
                <div className="flex items-center gap-2 py-1 cursor-pointer">
                  <div className="flex  gap-2 flex-col">
                    ...
                    <div className="q_details_header ml-5">
                      { NetSalesData.loading ? <div style={{width: "4rem"}}><Skeleton /></div> : priceFormate(Number(NetSalesData.NewItemSalesData[2])) }
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-2 py-1 cursor-pointer">
                  <div className="flex items-center gap-2 flex-col">
                    ...
                    <div className="q_details_header ml-5">
                      ...
                      { NetSalesData.loading ? <div style={{width: "5rem"}}><Skeleton /></div> : `$${priceFormate(Number(NetSalesData.NewItemSalesData[1]))}`}
                    </div>
                  </div>
                </div>
              </div>
