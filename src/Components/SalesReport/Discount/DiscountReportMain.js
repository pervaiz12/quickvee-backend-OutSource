import {
  ...
  const tableData = [
    ...
    {
      store: "Loyalty Points Discounts",
      total: "0",
      col1: "0.00",
      col2: "0.00",
      col3: "0.00",
  ...
  const tableRow = [
    { type: "str", name: "title", label: "Discount Name" },
    { type: "num", name: "quantity", label: "Sales Count" },
    { type: "num", name: "upc", label: "Net Discount%" },
    { type: "num", name: "price", label: "Net Discount Amount" },
  ];
  
  export default function DiscountReportMain({ hide = false }) {
      ...
      <>
        ...
        >
          <Grid item xs={12} md={6}>
            <VerticalBarChart title="Top Discounts" color="#0A64F9" />
          </Grid>
          <Grid item xs={12} md={6}>
            <VerticalBarChart title="Top Discounts by Amount Discounted" color="#FF7700" />
          </Grid>
        </Grid>
