...
import { fetchsystemAccessListData, updateSystemAccessData, addActualAmountData } from "../../../Redux/features/SystemAccess/systemAccessSlice";
...
const SystemAccessData = () => {
    ...
    useEffect(() => {
        ...
        if (systemAccess && systemAccess.report_history && systemAccess.report_history == 1) {
    ...
    const handleSave = () => {
        const data = {
            ...
            end_day_Allow: systemAccess.end_day_Allow == 1 ? "1" : (systemAccess.end_day_Allow == 2 ? "2" : "3"),
            // shift_assign: systemAccess.shift_assign,
            shift_assign: systemAccess.shift_assign == 1 ? "1" : (systemAccess.shift_assign == 2 ? "2" : "3"),
            start_date: systemAccess.start_date ? "1" : "2",
            end_date: systemAccess.end_date ? "1" : "2",
            start_time: systemAccess.start_time,
            end_time: systemAccess.end_time,
            report_history: systemAccess.report_history ? "1" : "0",
    ...
    const shouldShowEndOfDayButton = loginType == 'login_via_superadmin' && systemAccess.shift_assign == 3;

    // 
    useEffect(() => {
        if (shouldShowEndOfDayButton) {
            console.log("Executing logic for superadmin with shift_assign 3 on component load");
        }
    ...
    return (
        <>
            ...
            <div className="box_shadow_div">
                <div className="qvrow">
                    ...
                    <div className="col-qv-6">
                        <div className="input_area">
                            ...
                            <select name="end_day_Allow" value={systemAccess.end_day_Allow || ''}
                                onChange={handleEndOfDayAllowanceChange}
                            >
                                <option value="1" selected={systemAccess.end_day_Allow==1}>Deny if staff clocked in</option>
                                <option value="2" selected={systemAccess.end_day_Allow==2}>Mass clock out staff clocked in</option>
                                <option value="3" selected={systemAccess.end_day_Allow==3}>Ignore Time Clock</option>
                            </select>
                        </div>
                    </div>
                    <div className="col-qv-6">
                        <div className="input_area">
                            ...
                            <select name="shift_assign" id="shift_assign" value={systemAccess.shift_assign || ''}
                                onChange={handleShiftAssignmentChange} >
                                <option value="1" selected={systemAccess.shift_assign == 1}>Don’t Track Shifts</option>
                                <option value="2" selected={systemAccess.shift_assign == 2}>Track Shifts by Cashier</option>
                                <option value="3" selected={systemAccess.shift_assign == 3}>Track Shifts by Station</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                {/* <div className="col-qv-6">
                    <h5 className="box_shadow_heading">Actual Amount</h5>
                    <div className="input_area">
                    ...
                    <div className="qvrow">
                        <div className="col-md-6">
                            <button type="button" className="actual_amt_green_button" id="submit_actual_amt" value="" onClick={handleActualAmtSave}>
                                Save
                            </button>
                            <button type="button" className="actual_amt_cancel_button" data-dismiss="modal" >
                                Cancel
                            </button>
                        </div>
                    </div>
                ...
                <div className="qvrow">
                    ...
                    <div className="col-qv-6">
                        <div className="input_area">
                            ...
                            <select name="start_date" id="start_date" value={systemAccess.start_date || ''}
                                onChange={handleStartDateChange} >
                                <option value="1" selected={systemAccess.start_date == 1}>Yesterday</option>
                                <option value="2" selected={systemAccess.start_date == 2}>Today</option>
                            </select>
                        </div>
                    </div>
                    <div className="col-qv-6">
                        <div className="input_area">
                            <label>End Day</label>
                            <select name="end_date" id="end_date" value={systemAccess.end_date || ''}
                                onChange={handleEndDateChange} >
                                <option value="1" selected={systemAccess.end_date == 1}>Today</option>
                                <option value="2" selected={systemAccess.end_date == 2}>Tomorrow</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div className="qvrow">
                    <div className="col-qv-6">
                        <div className="input_area">
                            ...
                            <input
                                className="form-control bootstrap-timepicker"
                                type="text"
                                name="start_time"
                                value={systemAccess.start_time} //? formatTime(systemAccess.start_time) : ''}
                                id="start_tym"
                                required
                                ...
                                >
                                    <DemoItem>
                                        <MobileTimePicker
                                            ...
                                            name="start_time"
                                            id="start_tym"
                                        // value={systemAccess.start_time ? new Date(systemAccess.start_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : ''}
                                        onChange={handleStartTimeChange}
                                        />
                                    </DemoItem>
                                </DemoContainer>
                    ...
                    <div className="col-qv-6">
                        <div className="input_area">
                            ...
                            <input
                                ...
                                type="text"
                                name="end_time"
                                value={systemAccess.end_time}//? new Date(systemAccess.end_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' }) : ''}
                                id="end_tym"
                                required
                ...
                <div className="q-custom-modal-container" id="">
                    ...
                    <div className="q-custom-modal-content">
                        ...
                        <div className="q-add-categories-section-middle-footer">
                            <button
                                className="quic-btn quic-btn-save" id="submit_actual_amt" value="" onClick={handleActualAmtSave}
                            >
                                Save
                            </button>
                            <button
