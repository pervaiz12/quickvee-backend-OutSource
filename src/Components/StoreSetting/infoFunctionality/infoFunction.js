...
import {BASE_URL,GET_Edit_STORE_INFO,UPDATE_STORE_INFO} from '../../../Constants/Config'
export default function InfoFunction() {
  ...
  const handleEditRecord=async(dataRecord)=>{
    ...
    {
        const merchant_id=response.data.message.merchant_id !==null ? response.data.message.merchant_id:'';
        const name = response.data.message.name!== null ? response.data.message.name : '';
        const email = response.data.message.email!== null ? response.data.message.email : '';
        const menu_link = response.data.message.menu_link!== null ? response.data.message.menu_link : '';
        const domain_url=response.data.message.domain_url!==null ? response.data.message.domain_url:'';
        const img=response.data.message.img!==null ? response.data.message.img :'';
        const banner_img=response.data.message.banner_img !==null ? response.data.message.banner_img:'';
        const a_address_line_1=response.data.message.a_address_line_1!==null ? response.data.message.a_address_line_1:'';
        const a_address_line_2=response.data.message.a_address_line_2!==null ? response.data.message.a_address_line_2:''
        const a_city=response.data.message.a_city!==null ? response.data.message.a_city:'';
        const a_zip=response.data.message.a_zip!==null ? response.data.message.a_zip:''
        const state=response.data.message.a_state!==null ? response.data.message.a_state:''
        const phone=response.data.message.a_phone!==null ? response.data.message.a_phone:''
        setApprove('approve')
