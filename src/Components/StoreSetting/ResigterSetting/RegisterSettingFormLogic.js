...
const RegisterSettingFormLogic = () => {
  ...
  useEffect(() => {
    setValues((prevValues) => ({
      ...prevValues,
      regi_setting: registerData && registerData.regi_setting ? registerData.regi_setting : "",
      ebt_type: registerData && registerData.ebt ? registerData.ebt : "",
      idel_logout: registerData && registerData.idel_logout ? registerData.idel_logout : "",
      device_name: registerData && registerData.device_name ? registerData.device_name : "",
      customer_loyalty: registerData && registerData.customer_loyalty ? registerData.customer_loyalty : "",
      barcode_msg: registerData && registerData.barcode_msg ? registerData.barcode_msg : "",
      round_invoice: registerData && registerData.round_invoice ? registerData.round_invoice : "",
      discount_prompt: registerData && registerData.discount_prompt ? registerData.discount_prompt : "",
      denomination: registerData && registerData.denomination && parseInt(registerData.denomination) === 1 ? true : false,
