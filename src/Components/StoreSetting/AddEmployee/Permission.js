...
import {fetchEmployeeData , fetchPermissionData} from "../../../Redux/features/StoreSettings/AddEmployee/AddEmployeeSlice";
...
const Permission = () => {
    ...
    const employee_id = location.pathname.replace('/store-settings/permission/', '');
    ...
    <div className='q-attributes-main-page'>
        <div className="box_shadow_div_heading">
            <div className='page_heading_area'>
                ...
                <h1>{employeedata.f_name} {employeedata.l_name}'s Permissions</h1>
                </Link>
            </div>
                ...
                <div className=''>
                    <div className='input_rediobutton_area'>
                        <input
                            ...
                            checked={values.role === "manager" || values.role === null}
                    ...
                    <div className='input_rediobutton_area'>
                        <input
                            ...
                            value="cashier"
                            onChange={handleEditEmpPermissionInput}
                            checked={values.role === "cashier" && values.role !== null}
                    ...
                    <div className='input_rediobutton_area'>
                        <input
                            ...
                            onChange={handleEditEmpPermissionInput}
                            checked={values.role === "time_clock_only" && values.role !== null}
                                ...
                                <div className='checkbox_space'>
                                    <div className="qv_checkbox">
                                        <label className="qv_checkbox_add_checkmark_label">{subItem.sub_permission}
                                            <input type="checkbox" name="permission[]"  onChange={handleEditEmpPermissionInput} value={subItem.id} defaultChecked={idArray.includes(String(subItem.id))} // Convert subItem.id to string if necessary 
                                            />
                                            <span className="qv_add_checkmark"></span>
                                        </label>
                                    </div>
                    ...
                    <div className="qvrow">
                        <div className="col-qv-4">
                            <div className="input_area">
                                ...
                                />
                                <span className="input-error">
                                    {values.errors.break_allowed !== "" ? values.errors.break_allowed : ""}
                                </span>
                            </div>
                        </div>
                        <div className="col-qv-4">
                            <div className="input_area">
                                ...
                                />
                                <span className="input-error">
                                    {values.errors.break_time !== "" ? values.errors.break_time : ""}
                                </span>
                            </div>
                        </div>
                        <div className="col-qv-4">
                            <div className="input_area">
                                ...
                                />
                                <span className="input-error">
                                    {values.errors.paid_breaks !== "" ? values.errors.paid_breaks : ""}
                                </span>
                            </div>
                        </div>
                    </div>
