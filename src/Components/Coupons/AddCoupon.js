...
import { BASE_URL, COUPON_TITLE_CHECK ,ADD_COUPON} from "../../Constants/Config";
...
const AddCoupon = ({ seVisible }) => {
  ...
  const handleTabChange = (tab) => {
   ...
   const [coupon, setCoupon] = useState({
     ...
     time_expire: dayjs().add(1, 'hour').format("HH:mm:ss"),
     // "enable_limit"=>$this->input->post("enable_redemption_limit"),
     // "count_limit"=>$this->input->post("redemption_limit"),
   });
        ...
        <div className="q-add-categories-section">
          ...
          <div className="q-add-categories-section-middle-form">
            ...
            <div className="q-add-coupon-single-input">
              ...
              <textarea id="description" name="description" rows="4"  cols="50" value={coupon.description}
                    onChange={(e) =>
            ...
            <div className="q_coupon_calculation_amount row">
              <div className="q_coupon_minium col_minimun_order_amount">
                ...
                <input type="number" id="minorder_amt" name="minorder_amt" 
                value={coupon.min_amount}
                onChange={(e) => handleMinAmountChange(e)} placeholder="Enter Minimum Order Amount"/>
                {minOrderAmountError && (
              ...
              <div className="q_coupon_minium col_minimun_order_amount dicount_per_amo">
                {activeTab === "amount" && (
                  <div className="q_coupon_minium">
                    ...
                    <input type="number" id="discount_amt" name="discount" placeholder="Enter Discount Amount" value={coupon.discount}
                ...
                {activeTab === "percentage" && (
                  ...
                  <div className="q_coupon_minium">
                    ...
                    <input type="number" id="discount_per" name="discount" placeholder="Enter Discount Percentage"
                     value={coupon.discount} onChange={(e) => handleDiscountPercentChange(e)} />
                     {discountError && (
                                <p className="error-message">{discountError}</p>
                              )}
                  </div>
              ...
              {activeTab === 'percentage' && 
                <div className="q_coupon_minium mini_dis_Amt">
                  ...
                  <input type="number" id="maximum_discount" name="maximum_discount" placeholder="Enter Maximum Discount Amount"  value={coupon.maximum_discount}   onChange={(e) => handleMaxDiscountChange(e)}/>
                  {dateMaxDisAMTError && (
                            ...
                            <div className="q_time_display">
                              <LocalizationProvider dateAdapter={AdapterDayjs}>
                                <TimePicker
                                  ...
                                  name="start_tym"
                                  id="start_tym"
                                  // value={dayjs("YYYY-MM-DD HH:mm:ss A").toDate()}
            ...
            {couponStates.enable_limit > 0 &&
                <div className="q-add-coupon-single-input">
                  ...
                  <input type="number" id="count_limit" name="count_limit" min="1" max="999" value={coupon.count_limit}
                      onChange={(e) =>
                        setCoupon({
                          ...coupon,
          ...
          <div className="q-add-categories-section-middle-footer">
            <button className="quic-btn quic-btn-save"  onClick={handleAddButtonClick}>Add</button>
            <button
