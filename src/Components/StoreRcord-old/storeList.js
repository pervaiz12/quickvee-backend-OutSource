...
export default function StoreList() {
  ...
  let getSingleStore = (result) => {
    const matchedStorenew = AdminRocord?.data?.stores?.find(
    ...
    if (matchedStorenew) {
      ...
      return (
        <span
          onClick={() => handleGetRecord(matchedStorenew?.merchant_id)}
            ...
            <div>
              {
                ...
                AdminRocord?.data?.managers &&
                Array.isArray(AdminRocord?.data?.managers)
                  ? AdminRocord?.data?.managers?.map((result, index) => {
                      // console.log(result)
                      return (
                        <div key={index}>
                          <p>
                            <span>{result.f_name}</span>
                            <span>{result.l_name}</span>
                          </p>
